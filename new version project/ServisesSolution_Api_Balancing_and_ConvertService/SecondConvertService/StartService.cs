...
namespace ConvertService
{
    public class StartService : IStartService
    {
        ...
        {
            Console.WriteLine("start second convert service");
            var response =  client.PostAsync("https://localhost:44314/api/StartInstance/2000", new StringContent(string.Empty));
            Console.WriteLine(response);
        }
    }
}
